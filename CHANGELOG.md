...
### Added
- `Archetype.Tools` dotnet global tool (`dotnet archetype install-skills`) — installs versioned Claude Code skills into a game project's `.claude/skills/` directory; supports `--global` and `--overwrite`
