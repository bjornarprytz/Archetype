# action-args Specification

## Purpose
Defines how `PlayerAction` subtypes carry cost arguments and target arguments supplied by the host, how those arguments are bound into cost body execution context, and the structure of `ValidationResult`.
