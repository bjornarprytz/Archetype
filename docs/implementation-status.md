...
> Last updated: 2026-03-20 (D33: GDScript interop generation — EmitArchetypeNode, EmitInteropScripts, DeriveSignalSet extracted; ArchetypeNode.cs, archetype_signals.gd, archetype_interop.gd generated by BuildRunner. 177 C# tests passing)
...
| `Archetype.Build` | `Kw` factory shorthands, `GameDefinitionBuilder`, `CardSet` serialization, `BuildRunner`, `GodotEmitter` (D32, D33) | ✅ Complete |
